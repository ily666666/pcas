...
class HPNLearner(nn.Module):
    def __init__(self, inch):
        ...
        self.decoder1 = nn.Sequential(nn.Conv2d(outch3*2, outch3*2, (3, 3), padding=(1, 1), bias=True),
                                      nn.ReLU(),
                                      nn.Conv2d(outch3*2, outch2*2, (3, 3), padding=(1, 1), bias=True),
                                      nn.ReLU())

        self.decoder2 = nn.Sequential(nn.Conv2d(outch2*2, outch2, (3, 3), padding=(1, 1), bias=True),
                                      nn.ReLU(),
    ...
    def handle_4d(self,hypercorr_pyramid):
    ...
    def forward(self, hypercorr_pyramid1,hypercorr_pyramid2):
        hypercorr_encoded1 = self.handle_4d(hypercorr_pyramid1)
        hypercorr_encoded2 = self.handle_4d(hypercorr_pyramid2)
        hypercorr_encoded = torch.cat([hypercorr_encoded1,hypercorr_encoded2],dim=1)
