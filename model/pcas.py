...
class PCAS(nn.Module):
    ...
    def forward(self, query_img, support_img, support_mask,query_mask,training,epoch):
        support_img, support_mask = support_img.clone(), support_mask.clone()
        with torch.no_grad():
            ...
            support_feats2_mask_ = self.mask_feature(support_feats2, support_mask.clone())
             
             
             
             
            corr1 = Correlation.multilayer_correlation(query_feats, support_feats1_mask_, self.stack_ids)
            corr2 = Correlation.multilayer_correlation(query_feats, support_feats2_mask_, self.stack_ids)
        logit_mask1 = self.hpn_learner(corr1,corr2)
        ...
        logit_mask2 = self.hpn_learner(corr1, corr3)
