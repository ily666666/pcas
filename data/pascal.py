...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize):
        ...
        self.img_path = os.path.join(datapath, 'VOCDataset/VOCdevkit/VOC2012/JPEGImages/')
        self.ann_path = os.path.join(datapath, 'VOCDataset/VOCdevkit/VOC2012/SegmentationClassAug/')
